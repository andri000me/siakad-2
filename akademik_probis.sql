...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2017 at 03:03 AM
...
(10, 'kendaraan ringan', 'rifky', 's1', 8, '', 'mm', 4),
...
(22, 'kelistrikan', 'saya', 'd2', 4, '', 'd2', 14);
...
CREATE TABLE `app_agama` (
  ...
  `keterangan` varchar(25) COLLATE utf8_bin DEFAULT NULL
...
(1, 'nuris akbar sst', '748343', '196105041987032002', '43434', 'langsa', '2014-03-06', '2', 1, 1, 'sst', 'dsdsd', '081212123454', 'nu@gmail.com', 6),
...
(8, 'Alex Iskandar, Drs.,M.Pd.', '0423085601', '1111111', '', 'Sidoarjo', '1992-07-20', '1', 2, 1, '', 'Jln kenangan', '08572323232', 'ewewe@ddw', 6),
...
(21, 'Ahadiat, SST.,M.Pd.', '0423065703', '212122332', '', 'qwqwqwqw', '1996-07-19', '1', 1, 2, '', 'sample text', '08562323232', 'ahadiat@gmail.com', 5),
...
(5, 'L1.R08', 0, 50, ''),
(6, 'L1.R09', 0, 25, ''),
(17, 'LAB 1a', 3, 55, 'perbaikan'),
(22, 'LAB 2b', 3, 50, 'lab dasar'),
(23, 'lab 1b', 2, 30, 'lab AK'),
(24, 'lab 3a', 14, 50, 'lab multimedia'),
(34, 'a2', 0, 12, 'ssss');
...
(4, 'informatika', '', 'informatika', 2, '6', '2014-09-06 10:57:51'),
(6, 'nuris', 'nuris akbar', '74d7273be4b0ddeac49bfa169b288c5b', 4, '1', '2014-09-06 11:12:14'),
...
--
ALTER TABLE `akademik_konsentrasi`
  MODIFY `konsentrasi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `app_gedung`
  MODIFY `gedung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
